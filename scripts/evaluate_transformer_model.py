...
def main(args):
    ...
    model_acc, precision_avg, recall_avg, model_scores, model_avg_f1 = calculate_scores(model_predictions)
    ...
    benchmark_acc, precision_avg, recall_avg, benchmark_scores, benchmark_avg_f1 = calculate_scores(benchmark_predictions)

    # Print the accuracies and save the F1 scores for each label

    print('Model accuracy: {}'.format(model_acc))
    print('Model precision average: {}'.format(precision_avg))
    print('Model recall average: {}'.format(recall_avg))
    print('Model average F1: {}'.format(model_avg_f1))
    print('Benchmark accuracy: {}'.format(benchmark_acc))
    print('Benchmark precision average: {}'.format(precision_avg))
    print('Benchmark recall average: {}'.format(recall_avg))
